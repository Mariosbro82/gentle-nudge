                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-16">
                        <motion.div
                            ...
                            className="inline-block px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-500 text-sm font-medium mb-6"
                        >
                            Analytics & Insights
                        </motion.div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-24">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                className="p-8 rounded-2xl bg-card border border-border hover:border-blue-500/30 transition-colors group"
                            >
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <Link to="/login">
                                <Button className="bg-white text-blue-900 hover:bg-blue-50 rounded-full px-8 py-6 text-lg font-bold">
