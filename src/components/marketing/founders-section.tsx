        ...
        <section className="py-24 bg-zinc-950/50 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Die Köpfe hinter Severmore</h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative p-8 rounded-3xl bg-zinc-900/80 border border-white/10 backdrop-blur-sm h-full flex flex-col items-center text-center hover:border-blue-500/30 transition-colors">
                            <div className="w-32 h-32 rounded-full border-4 border-zinc-950 shadow-2xl mb-6 overflow-hidden bg-zinc-800">
                                <Avatar className="w-full h-full">
                                    <AvatarImage src="/images/founders/tjark.png" alt="Tjark Schmitt" className="object-cover" />
                                    <AvatarFallback>TS</AvatarFallback>
                                </Avatar>
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-1">Tjark Schmitt</h3>
                            ...
                            <div className="mt-auto px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs text-zinc-500">
                                Fokus: Design & Tech
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative p-8 rounded-3xl bg-zinc-900/80 border border-white/10 backdrop-blur-sm h-full flex flex-col items-center text-center hover:border-purple-500/30 transition-colors">
                            <div className="w-32 h-32 rounded-full border-4 border-zinc-950 shadow-2xl mb-6 overflow-hidden bg-zinc-800">
                                <Avatar className="w-full h-full">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-1">Noah Solaker</h3>
