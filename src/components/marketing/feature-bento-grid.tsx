        ...
        <section className="py-24 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-6xl mx-auto auto-rows-[minmax(220px,auto)]">
                    ...
                    {/* ═══ NEW ROW: KI-Assistent + Video-Begrüßung + Top-Performer ═══ */}
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="md:col-span-2 md:row-span-1 rounded-3xl glass-card p-8 flex flex-col relative overflow-hidden group"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-2">KI-Assistent</h3>
                            <p className="text-muted-foreground text-sm">
                        ...
                        <div className="mt-4 flex gap-2">
                            ...
                            <div className="px-3 py-1.5 rounded-full bg-muted/50 border border-border text-[11px] text-muted-foreground">Eigene Wissensbasis</div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-foreground mb-2">Video-Begrüßung</h3>
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-foreground mb-2">Top-Performer</h3>
                        <p className="text-muted-foreground text-xs">
                            Gamification für Ihr Sales-Team. Wer sammelt die meisten Leads? Live-Ranking im Dashboard.
                        </p>
                    </motion.div>

                    {/* ═══ ROW 3: Presets + CSV Export ═══ */}
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="md:col-span-2 md:row-span-1 rounded-3xl glass-card p-8 flex items-center gap-6 relative overflow-hidden group"
                    >
                        ...
                        <div className="relative z-10 flex-1">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-foreground">Profil-Presets</h3>
                            </div>
                            <p className="text-muted-foreground text-sm">
                        ...
                        <div className="relative z-10 flex flex-col gap-1.5 min-w-[120px]">
                            {["Messe CES", "Office", "Konferenz"].map((preset, i) => (
                                <div key={preset} className={`px-3 py-2 rounded-lg text-xs font-medium border transition-all ${i === 0 ? "bg-cyan-500/10 border-cyan-500/30 text-cyan-400" : "bg-muted/30 border-border text-muted-foreground"}`}>
                                    {i === 0 && "● "}{preset}
                                </div>
                            ))}
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10 flex-1">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-foreground">CSV Export & Bulk Import</h3>
                            </div>
                            <p className="text-muted-foreground text-sm">
