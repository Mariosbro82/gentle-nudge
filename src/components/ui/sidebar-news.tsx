...
const defaultArticles: NewsArticle[] = [
  {
    title: "System Update v2.4 Available",
    summary: "New batch import features and improved analytics dashboard are now live.",
    image: "https://images.unsplash.com/photo-1629904853716-6c0abdcc751d?q=80&w=2500&auto=format&fit=crop",
    href: "#",
  },
  {
    title: "Maintenance Schedule",
    summary: "Scheduled maintenance for Feb 15th, 02:00 AM - 04:00 AM UTC.",
    image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2500&auto=format&fit=crop",
    href: "#",
  },
  {
    title: "New NFC Chip Support",
    summary: "Added support for NTAG216 chips with expanded memory capacity.",
    image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2500&auto=format&fit=crop",
    href: "#",
  },
];

export function SidebarNews({ articles = defaultArticles }: { articles?: NewsArticle[] }) {
  ...
  return cards.length || showCompleted ? (
    ...
    >
      <div className="relative size-full">
        ...
        {/* Placeholder for empty state animation if needed, or just hidden elements */}
