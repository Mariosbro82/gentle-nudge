...
-- Update public_profiles view to include new greeting columns
...
SELECT
  ...
  company_name, social_links, active_template,
  ghost_mode, ghost_mode_until, website, linkedin_url,
  view_count, background_image, background_color,
  banner_color, accent_color, custom_links,
